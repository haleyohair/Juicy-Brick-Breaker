...
var indicator_scale_target = Vector2(2.0,2.0)
...
func breathe():
	...
	for i in $Indicator_Container.get_children():
		tween.tween_property(i.get_node("Highlight"), "scale", indicator_scale, 0.7)
		tween.tween_property(i.get_node("Highlight"), "modulate:a", indicator_mod,0.7)
